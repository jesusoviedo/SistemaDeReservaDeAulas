...
<body>
    ...
    <div class="container">
        <h3>Nuevo estado de Reserva</h3>
        <form action="/EstadoReserva/Create" method="post" >

            <div class="form-group">
                <label class="form">Descripción:</label>
                <input class="form-control col-md-4" type="text" name="txtDescripcion" placeholder="Descripcion" required />
            </div>
